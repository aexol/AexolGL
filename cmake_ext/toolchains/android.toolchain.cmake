...
list(APPEND CMAKE_FIND_ROOT_PATH "${ANDROID_NDK}" "${AEXOL_SDK}")
...
endforeach()
if(ANDROID_ABI MATCHES "^(armeabi(-v7a)?|x86)$" AND NOT ANDROID_STL MATCHES "^(none|system)$")
	list(APPEND ANDROID_CXX_STANDARD_LIBRARIES
		-latomic)
endif()
...
if(ANDROID_CXX_STANDARD_LIBRARIES)
	string(REPLACE ";" "\" \"" _stl_init "\"${ANDROID_CXX_STANDARD_LIBRARIES}\"")
	set(CMAKE_CXX_STANDARD_LIBRARIES_INIT "${CMAKE_CXX_STANDARD_LIBRARIES_INIT} ${_stl_init}")
endif()
...
if(CMAKE_VERSION VERSION_LESS "3.6")
    foreach(stl_include ${CMAKE_CXX_STANDARD_INCLUDE_DIRECTORIES})
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -isystem ${stl_include}")
    endforeach()
endif()
