...
// Singleton
    ...
    public:
        ...
        int takePicture(JNIEnv* env, std::string path, int width, int height, int format, int JPGQuality, int filter, int camID);
        int startVideo(JNIEnv* env, std::string path, int width, int height, int camID);
        ...
        int getFlatten(JNIEnv* env, std::string* result, int camID);
        ...
        int getUserDataDirectory(JNIEnv* env, std::string* result);
        int getDownloadCacheDirectory(JNIEnv* env, std::string* result);
        int getExternalStorageDirectory(JNIEnv* env, std::string* result);
        int getExternalStoragePublicDirectory(JNIEnv* env, int type, std::string* result);
        int mkdir(JNIEnv* env, const std::string& path);
        
        int openGallery(JNIEnv* env, const std::string& path);
        // rem
        // CM - CameraMediator
